...
// Configura o watcher para monitorar mudanças nos arquivos
const watcher = chokidar.watch("src/**/*.js", {
  persistent: true,
});

// Quando um arquivo é alterado, processa o arquivo
watcher.on("change", (filePath) => {
  processFile(filePath);
});

// Quando um arquivo é adicionado, processa o arquivo
